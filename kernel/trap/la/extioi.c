...
uint64 extioi_claim(void) { return iocsr_readq(LOONGARCH_IOCSR_EXTIOI_ISR_BASE); }

void extioi_complete(uint64 irq) { iocsr_writeq(irq, LOONGARCH_IOCSR_EXTIOI_ISR_BASE); }